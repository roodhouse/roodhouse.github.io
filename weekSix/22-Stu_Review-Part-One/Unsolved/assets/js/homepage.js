...
var formSubmitHandler = function (event) { // taking user name for searching of repos
  event.preventDefault(); // stop the button from refreshing the page

  var username = nameInputEl.value.trim(); // removes ws from string
...
var buttonClickHandler = function (event) {
  ...
  // TODO: Write your answer here
  // to check the boolean of the language
  if (language) {
